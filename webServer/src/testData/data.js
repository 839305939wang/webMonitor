...
[Date.UTC(2015,5,30),0.8950]
 ...
 chart3:[{
			            ...
			            data: [
			                ...
			                [Date.UTC(1970, 10, 10), 23 ],
			                [Date.UTC(1970, 10, 18), 100 ],
			                [Date.UTC(1970, 11,  2), 234 ],
			                [Date.UTC(1970, 11,  9), 0.3 ],
			                [Date.UTC(1970, 11, 16), 66 ],
			                [Date.UTC(1970, 11, 28), 67],
			                [Date.UTC(1971,  0,  1), 81],
			                [Date.UTC(1971,  0,  8), 78],
			                [Date.UTC(1971,  0, 12), 98],
			                [Date.UTC(1971,  0, 27), 184],
			                [Date.UTC(1971,  1, 10), 180],
			                [Date.UTC(1971,  1, 18), 180],
			                [Date.UTC(1971,  1, 24), 192],
			                [Date.UTC(1971,  2,  4), 249],
			                [Date.UTC(1971,  2, 11), 279],
			                [Date.UTC(1971,  2, 15), 273],
			                [Date.UTC(1971,  2, 25), 261],
			                [Date.UTC(1971,  3,  2), 276],
			                [Date.UTC(1971,  3,  6), 282],
			                [Date.UTC(1971,  3, 13), 28 ],
			                [Date.UTC(1971,  4,  3), 21 ],
			                [Date.UTC(1971,  4, 26), 11 ],
			                [Date.UTC(1971,  5,  9), 25],
			            ...
			            data: [
			                ...
			                [Date.UTC(1970, 11,  1), 47],
			                [Date.UTC(1970, 11, 11), 55],
			                [Date.UTC(1970, 11, 25), 138],
			                [Date.UTC(1971,  0,  8), 138],
			                [Date.UTC(1971,  0, 15), 138],
			                [Date.UTC(1971,  1,  1), 138],
			                [Date.UTC(1971,  1,  8), 148],
			                [Date.UTC(1971,  1, 21), 15 ],
			                [Date.UTC(1971,  2, 12), 189],
			                [Date.UTC(1971,  2, 25), 20 ],
			                [Date.UTC(1971,  3,  4), 194],
			                [Date.UTC(1971,  3,  9), 191],
			                [Date.UTC(1971,  3, 13), 175],
			                [Date.UTC(1971,  3, 19), 16 ],
			                [Date.UTC(1971,  4, 25), 6 ],
